// A local community center is holding a fund raising 5k 
//fun run and has invited 50 small businesses to make a small 
//donation on their behalf for some much needed updates to their facilities.  
//Each business has assigned a representative to attend the event along with a 
//small donation.
...
//for their running bibs.  Combine both the first and last names into a new 
//array called fullName. 
//let fullName = [runners.forEach(first_name,last_name)]
...
//to uppercase because the director BECAME DRUNK WITH POWER. Convert each first 
//name into all caps and log the result .map
